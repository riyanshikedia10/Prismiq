...
SYSTEM_PROMPT = """You are an expert interview coach specializing in Data Scientist interviews \
...
def generate_question(
    ...
    Args:
        ...
        role: Role name (e.g. "Data Scientist")
        experience_level: "Entry", "Mid", or "Senior"
        round_name: Interview round name (e.g. "Technical Screen")
